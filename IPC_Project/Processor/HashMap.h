 ...
 *
 *  @author Oded Neaman  (oded.neaman@gmail.com)
 * 
 *  @bug Hash_find removes the search key! 
 */
...
typedef int	(*UpdateFunc)(void* _inValue, void* _addValue);
 ...
 */
size_t HashMap_ForEach(const HashMap* _map, KeyValueActionFunction _action, void* _context); /* context = key + value */
